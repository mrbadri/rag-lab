...
from embedding.custom import CustomGapGPTEmbeddingLangchain

# Constants
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "chapter_2"
INPUT_JSON = DATA_DIR / "normal-docs-unstructured.json"
OUTPUT_JSON = DATA_DIR / "split-docs-unstructured-standard-deviation.json"
